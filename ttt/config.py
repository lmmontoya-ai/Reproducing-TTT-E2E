"""Configuration schema for local TTT-E2E reproduction code.

This module intentionally mirrors the *shape* of the reference configuration
API while keeping all implementation in the main repository.
"""
...
class OptimizerConfig:
    optimizer_type: OptimizerType = MISSING
...
class TrainingConfig:
    ...
    model_seed: int = 0
    data_seed: int = 0
    load_part: LoadPart = LoadPart.none
...
def register_configs() -> None:
    """Register Hydra config groups used throughout experiments.

    Guarded for idempotency so repeated imports/calls in scripts do not
    re-register and fail.
    """
