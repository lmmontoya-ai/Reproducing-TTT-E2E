...
COMMANDS: list[ExperimentCommand] = [
    ...
    ExperimentCommand(
        ...
        notes="Qwen imported FA stage A (requires import-qwen05-fa-base checkpoint)",
        path_group="adapter",
    ...
    ExperimentCommand(
        ...
        notes="Smol imported FA stage A (requires import-smol360-fa-base checkpoint)",
        path_group="adapter",
        requires_profile=True,
    ),
    ExperimentCommand(
